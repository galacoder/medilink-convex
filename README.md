...
> This project uses `@medilink` as the package scope for all workspace packages.
...
pnpm --filter @medilink/auth generate
```
...
3. Outputs a Drizzle-compatible schema file to the `@medilink/db` package
