/**
 * Tests for AIAssistantWidget component in features/ai-assistant/.
 *
 * WHY: Verifies that:
 * - Floating button renders for hospital and provider portals
 * - Sidebar opens on button click
 * - CopilotKit provider wraps the content
 * - Portal-specific titles are applied
 *
