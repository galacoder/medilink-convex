...
describe("EquipmentSelector", () => {
  it("test_EquipmentSelector_rendersEquipmentOptions", () => {
    mockUseQuery.mockReturnValue(
      mockEquipmentList as unknown as ReturnType<typeof useQuery>,
    );

    renderWithProviders(<EquipmentSelector value="" onSelect={vi.fn()} />);
  ...
  it("test_EquipmentSelector_callsOnSelect", () => {
    ...
    renderWithProviders(<EquipmentSelector value="" onSelect={onSelect} />);
