...
/**
 * Provider support ticket list page.
 *
 * WHY: Provider staff create and track support tickets here.
 * Same functionality as hospital support page.
 *
 * vi: "Trang ho tro nha cung cap" / en: "Provider support page"
 */
export default function ProviderSupportPage() {
  ...
  return (
    <div className="space-y-6" data-testid="provider-support">
      {/* Page header */}
      ...
      <TicketList
        ...
        isLoading={isLoading}
        onTicketClick={(id) => {
          window.location.href = `/provider/support/${id}`;
        }}
      />
    </div>
  );
