...
/**
 * Provider AI Assistant page.
 *
 * WHY: Provider users need a dedicated page to interact with the AI assistant
 * and browse conversation history. Org-scoped via useActiveOrganization.
 *
 * vi: "Trang tro ly AI nha cung cap" / en: "Provider AI assistant page"
 */
  ...
  return (
    <div className="space-y-6" data-testid="provider-ai-assistant">
      ...
      {isPending ? (
        ...
        <AiChatPage portal="provider" organizationId={organizationId} />
      )}
    </div>
  );
}
